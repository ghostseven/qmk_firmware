...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * ,----------------------------------------------------------------.
     * |~ `| F1| F2| F3| F4| F5| F6| F7| F8| F9|F10|F11|F12| Delete| End|
     * |----------------------------------------------------------------|
     * |QK_BOOT|   | ↑ |   |   |   |   |   |   |   |   |   |   |   |    |
     * |-------------------------------------------------------    -----|
     * |       | ← | ↓ | → |   |   |   |   |   |   |   |  |   |    |    |
     * |----------------------------------------------------------------|
     * |HUI |SAI|VAI |RGBMOD|  |   |   |   |   |    |  |Mut |Play|V+|Ins|
     * |----------------------------------------------------------------|
    ...
    [_FL] = LAYOUT_65_iso(
        ...
        RGB_HUI, RGB_SAI, RGB_VAI, RGB_MOD, _______, _______, _______, _______, _______, _______, _______, _______, KC_MPLY, KC_VOLU, KC_INS,
        RGB_HUD, RGB_SAD, RGB_VAD,                            RGB_TOG,                   _______, KC_TRNS, KC_MUTE, KC_MPRV, KC_VOLD, KC_MNXT
    )
};
